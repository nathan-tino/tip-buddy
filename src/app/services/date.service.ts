...
export class DateService {
	...
	/**
	 * Creates a local Date object from two separate Date objects, one representing the date
	 * and the other representing the time.
	 * @param dateObject - The local Date object.
	 * @param timeObject - Optional Date object that represents the local time.
	 * @returns A local Date object representing the user's intended date/time.
	 */
	combineDateAndTimeObjects(dateObject: Date, timeObject?: Date): Date {
		...
		let hours = 8; // default hour //TODO: Make this configurable
		...
		// Create a local date representing the user's intended local time
